...
public class RefreshListView extends ListView implements AbsListView.OnScrollListener {
    ...
    private void init(Context context) {
        ...
        //加载头布局
        headView = (RelativeLayout) LayoutInflater.from(context).inflate(R.layout.header, this, false);
        //测量头布局
        ...
        //获取动画
        wheelAnimation = AnimationUtils.loadAnimation(context, R.anim.wheel_anim);
        sunAnimation = AnimationUtils.loadAnimation(context, R.anim.sun_anim);
    ...
    private void measureView(RelativeLayout headView) {
